...
namespace Ajax_crud.Controllers
{
    ...
    public HomeController(ILogger < HomeController > logger) {
        ...
        students.Add(new StudentModel() {
            Id = 1, Email = "ankush1802@outlook.com", Name = "Ankush"
        });
        students.Add(new StudentModel() {
            Id = 2, Email = "rohit@outlook.com", Name = "Rohit"
        });
        students.Add(new StudentModel() {
            Id = 3, Email = "sunny@outlook.com", Name = "Sunny"
        });
        students.Add(new StudentModel() {
            Id = 4, Email = "amit@outlook.com", Name = "Amit"
        });
    }

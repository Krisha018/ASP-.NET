...
{
    public class User_Booking_Base_DAL:DAL_Helper
    {
        ...
        public List<User_BookingModel> BookingList()
        {
            List<User_BookingModel> list = new List<User_BookingModel>();
            ...
            using (IDataReader reader = db.ExecuteReader(cmd))
            {
                while (reader.Read())
                {
                    User_BookingModel model = new User_BookingModel();
        ...
        public User_BookingModel Booking_SelectByPK(int BookingID)
        {
            SqlDatabase db = new SqlDatabase(ConnString);
        ...
        #region BookingAdd
        public bool Booking_Insert(User_BookingModel model)
        {
            try
            {
                SqlDatabase db = new SqlDatabase(ConnString);
        ...
        public bool Booking_Update(User_BookingModel model)
        {
            try
            {
                SqlDatabase db = new SqlDatabase(ConnString);
